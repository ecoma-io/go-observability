...
func (x *HelloResponse) GetRequestCount() int32 {
	if x != nil {
...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\rrequest_count\x18\x02 \x01(\x05R\frequestCount2\x84\x01\n" +
	"\fHelloService\x125\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\x12=\n" +
	"\x0eSayHelloStream\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse0\x01BBZ@github.com/ecoma-io/go-observability/examples/grpc-service/protob\x06proto3"
